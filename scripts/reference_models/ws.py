...
from app.graphs import create_ws_graph
...
def main() -> None:
    ...
    er_graph = create_ws_graph(n_nodes, n_edges)
    calculate_basic_analysis(er_graph, "WS graph")


if __name__ == "__main__":
    logs_file_path = Path("scripts", "logs", "ws.log")
