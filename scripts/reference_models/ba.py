...
from app.graphs import create_ba_graph
...
def main() -> None:
    ...
    er_graph = create_ba_graph(n_nodes, n_edges)
    calculate_basic_analysis(er_graph, "BA graph")


if __name__ == "__main__":
    logs_file_path = Path("scripts", "logs", "ba.log")
